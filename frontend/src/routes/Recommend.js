...
function Recommend ({userInfo}) {
    ...
    useEffect(() => {
        setVideos([{"id":"h8TLXfcqP_s"},{"id":"wursWCYQ-y8"},{"id":"kZz5BqihN5Y"}])
                        ...
                        <div className='recommend__container__videosBox'>
                            {videos.map(video => (
                                <div className="recommend__container__videosBox__video" key={video.id}>
                                    <div>
                                        ...
                                        <img className="summary__recommend__contents__video" src={`https://img.youtube.com/vi/${video.id}/mqdefault.jpg`} width="180px" />
                            ...
                            {videos.map((video) => (
                                <div className="recommend__container__videosBox__video" key={video.id.videoId}>
                                    <div className="history__list__content">
                                        <a className="summary__recommend__contents__linkA" href={`https://www.youtube.com/watch?v=${video.id.videoId}`} target="_blank" rel="noopener noreferrer">
                                            <img className="summary__recommend__contents__video" src={`https://img.youtube.com/vi/${video.id.videoId}/mqdefault.jpg`} width="180px" />
